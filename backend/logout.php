...
<head>
        <meta charset="utf-8" />
        <title>Highdmin - Log Out Page</title>
    ...
    <body class="account-pages">
        ...
        <!-- Begin page -->
        <div class="accountbg" style="background: url('assets/images/img-3.jpg');background-size: cover;background-position: center;"></div>
