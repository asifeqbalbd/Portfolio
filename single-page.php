        <?php 
            ...
            $query_portfolio = mysqli_query($db, $select);
            $assoc_portfolio = mysqli_fetch_assoc($query_portfolio);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="images/portfolio/<?= $assoc_portfolio['images']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?= $assoc_portfolio['title']?></h2>
                                    <p><?= $assoc_portfolio['description']?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img height="50px" src="images/portfolio/<?= $assoc_portfolio['images']?>" alt="img">
                                            </div>
